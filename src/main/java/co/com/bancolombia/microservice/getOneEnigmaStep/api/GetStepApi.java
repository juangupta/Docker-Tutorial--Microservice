...
public interface GetStepApi {
    ...
    @ApiOperation(value = "Get  one enigma step API", nickname = "getOneEnigmaStep", notes = "Get  one enigma step API", response = JsonApiBodyResponseSuccess.class, tags={ "get-one-enigma-step-api-controller", })
    @ApiResponses(value = { 
